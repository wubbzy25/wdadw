...
export const ColorForm: React.FC<ColorFormProps> = ({
  ...
  const description = initialData ? 'Editar un color.' : 'añadir un nuevo color';
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error('Asegúrate de haber eliminado todos los productos que utilizan este color primero..');
    } finally {
      setLoading(false);
      setOpen(false);
    }
