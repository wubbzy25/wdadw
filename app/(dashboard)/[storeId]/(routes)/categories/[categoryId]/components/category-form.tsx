...
export const CategoryForm: React.FC<CategoryFormProps> = ({
  ...
  const description = initialData ? 'Editar una categoria.' : 'Añadir una nueva categoria';
  ...
  const onDelete = async () => {
    try {
      ...
      router.refresh();
      router.push(`/${params.storeId}/categories`);
      toast.success('Categoria Eliminda.');
    } catch (error: any) {
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select disabled={loading} onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue defaultValue={field.value} placeholder="Seleciona un billboard" />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
